/*
 * Quantum Menu  Patches/Menu/EffectDataPatch.cs
            ...
            if (enabled)
            {
                if (__instance.isLocal)
                {
                    ...
                    if (material > 0)
                    {
                        ...
                        if (isLeftHand)
                            GorillaLocomotion.GTPlayer.Instance.leftHand.materialTouchIndex = material;
                        else
                            GorillaLocomotion.GTPlayer.Instance.rightHand.materialTouchIndex = material;
