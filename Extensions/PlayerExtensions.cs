/*
 * Quantum Menu  Extensions/PlayerExtensions.cs
...
namespace Quantum.Extensions
{
    public static class PlayerExtensions
    {
        ...
        {
            return
                Physics.Raycast(tagger.bodyCollider.transform.position - new Vector3(0f, 0.2f, 0f), Vector3.down, maxDistance, GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers);
        }
        #endregion
    }
}
