...
namespace Quantum.Managers
{
    ...
    {
        public static string SystemPrompt = @"NAME: Quantum's Voice Assistant
        MENU VERSION: {2}
        MOD COUNT: {0}

        You are a voice assistant for a Gorilla Tag mod menu called ""Quantum Menu"". You are not Quantum, but represent the menu.
        GitHub: https://github.com/Quantum
        Quantum's Discord Server: {1}
        ...
        {
            string filePath = $"{PluginInfo.BaseDirectory}/Quantum_SystemPrompt.txt";
