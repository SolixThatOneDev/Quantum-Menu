using Quantum.Managers.DiscordRPC.Events;
using Quantum.Managers.DiscordRPC.Exceptions;
using Quantum.Managers.DiscordRPC.IO;
using Quantum.Managers.DiscordRPC.Logging;
using Quantum.Managers.DiscordRPC.Message;
using Quantum.Managers.DiscordRPC.RPC;
using Quantum.Managers.DiscordRPC.RPC.Commands;
using System;

namespace Quantum.Managers.DiscordRPC
{
