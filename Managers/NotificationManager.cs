...
namespace Quantum.Managers
{
    public class NotificationManager : MonoBehaviour
    {
        ...
        private void Init()
        {
            ...
            GameObject canvasParent = new GameObject("Quantum_NotificationParent");
        ...
        private void FixedUpdate()
        {
            try
            {
                ...
                canvas.transform.localScale = Vector3.one * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f);
