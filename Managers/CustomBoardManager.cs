/*
 * Quantum Menu  Managers/CustomBoardManager.cs
...
namespace Quantum.Managers
{
    public class CustomBoardManager : MonoBehaviour
    {
        ...
        public static string motdTemplate = "You are using Build {0} (The v1.22 Update!). This menu was created by Solix. credits to kingofnetflix. " +
                ...
                try
                {
                    ...
                    foreach (string objectName in objectsWithTMPro)
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            LogManager._v3_out_("Could not find " + objectName);
                    }
