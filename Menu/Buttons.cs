    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Overpowered Mods [17]
                ...
                new ButtonInfo { buttonText = "Freeze Server", method =() => Overpowered.FreezeServer(), disableMethod = Overpowered.DisableFreezeServer, toolTip = "Freezes the room using a distributed high-pressure flood." },
