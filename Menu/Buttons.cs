    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            new[] { // Main [0]
                ...
                new ButtonInfo { buttonText = "Join Discord", method = Important.JoinDiscord, isTogglable = false, toolTip = "Invites you to join the <b>Quantum</b> Discord server."},
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Custom Menu Name", enableMethod = Settings.CustomMenuName, disableMethod =() => doCustomName = false, toolTip = $"Changes the name of the menu to whatever. You can change the text inside of your Gorilla Tag files ({PluginInfo.BaseDirectory}/Quantum_CustomMenuName.txt)."},
                ...
                new ButtonInfo { buttonText = "Premium Watermark", enableMethod = Settings.TogglePremiumWatermark, disableMethod = Settings.TogglePremiumWatermark, toolTip = "Enables a modern, sleek watermark on the top of your screen with live stats."},
                new ButtonInfo { buttonText = "Disable Watermark", enableMethod = Settings.EnableWatermark, disableMethod = Settings.EnableWatermark, toolTip = "Disables the watermark on the UI and the back of the menu."},
                ...
                new ButtonInfo { buttonText = "Custom Font Type", enableMethod = Settings.CustomFontType, method = Settings.PersistCustomFont, disableMethod = Settings.DisableCustomFont, toolTip = $"Changes the font type on the menu to a custom font. You can change the photo inside of your Gorilla Tag files ({PluginInfo.BaseDirectory}/Quantum_CustomWatermark.txt)."},
            ...
            new[] { // Room Mods [6]
                ...
                new ButtonInfo { buttonText = "Join Menu Room", method =() => PhotonNetworkController.Instance.AttemptToJoinSpecificRoom($"<$Quantum_{PluginInfo.Version}>", JoinType.Solo), isTogglable = false, toolTip = "Connects you to a room that is exclusive to <b>Quantum Menu</b> users." },
            ...
            new[] { // Important Mods [7]
                ...
                new ButtonInfo { buttonText = "Discord RPC", aliases = new[] { "Self Tracker" }, method = Important.DiscordRPC, disableMethod = Important.DisableDiscordRPC, toolTip = "Gives you a indicator on Discord that you are using Quantum Menu."},
                ...
                new ButtonInfo { buttonText = "Print Photon ID", method = Important.PrintPhotonID, isTogglable = false, toolTip = "Sends a notification with your current Photon UserID for debugging purposes."},
                new ButtonInfo { buttonText = "Force Admin Panel", method = Important.ManualAdminSetup, isTogglable = false, toolTip = "Manually triggers the admin panel setup. Use this if automatic detection fails."},
            },
            ...
            new[] { // Movement Mods [9]
                ...
                new ButtonInfo { buttonText = "WASD Fly", aliases = new[] { "PC Fly" }, enableMethod = Movement.EnableWASDFly, method = Movement.WASDFly, disableMethod =() => GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).parent.rotation = Quaternion.Euler(0, 0, 0), toolTip = "Moves your rig with <color=green>WASD</color>."},
                ...
                new ButtonInfo { buttonText = "Uncap Max Velocity", aliases = new[] { "Velmax" }, method =() => GorillaLocomotion.GTPlayer.Instance.maxJumpSpeed = float.MaxValue, toolTip = "Removes the velocity limit of walking."},
                ...
                new ButtonInfo { buttonText = "Uncap Arm Length", aliases = new[] { "Armmax" }, method =() => { GorillaLocomotion.GTPlayer.Instance.leftHand.maxArmLength = float.MaxValue; GorillaLocomotion.GTPlayer.Instance.rightHand.maxArmLength = float.MaxValue; }, disableMethod =() => { GorillaLocomotion.GTPlayer.Instance.leftHand.maxArmLength = 1; GorillaLocomotion.GTPlayer.Instance.rightHand.maxArmLength = 1; }, toolTip = "Removes the arm distance limit."},
            ...
            new[] { // Overpowered Mods [17]
                ...
                new ButtonInfo { buttonText = "Quantum Kick Gun", method = Overpowered.QuantumKickGun, toolTip = "A specialized kick gun with custom velocity logic (Freeze -> 7s Countdown -> Final Kick)." },
                new ButtonInfo { buttonText = "Quantum Kick All", method = () => CoroutineManager.instance.StartCoroutine(Overpowered.KickGunCoroutine("All", null)), toolTip = "A specialized kick all with custom velocity logic (Freeze -> 7s Countdown -> Final Kick)." },
                new ButtonInfo { buttonText = "Change Kick Speed", overlapText = "Change Kick Speed <color=grey>[</color><color=green>Fast</color><color=grey>]</color>", method = () => { Overpowered.kickty = (Overpowered.kickty == 1) ? 2 : 1; Buttons.GetIndex("Change Kick Speed").overlapText = "Change Kick Speed <color=grey>[</color><color=green>" + (Overpowered.kickty == 1 ? "Fast" : "Slow") + "</color><color=grey>]</color>"; }, isTogglable = false, toolTip = "Changes the delay in the kick gun coroutine." },
            ...
            new[] { // Internal Mods (hidden from user) [25]
                ...
                //new ButtonInfo { buttonText = "Donate Button", method =() => { NotificationManager.ClearAllNotifications(); acceptedDonations = true; File.WriteAllText($"{PluginInfo.BaseDirectory}/Quantum_HideDonationButton.txt", "true"); Prompt($"If you like this menu and would like to support, you should join our Patreon! ", () => Process.Start("https://patreon.com/Quantum")); }, isTogglable = false, toolTip = "An advertisement for my Patreon." },
            ...
            new[] { // Credits [38]
                ...
                new ButtonInfo { buttonText = "Quantum", method =() => Process.Start("https://github.com/Quantum"), isTogglable = false, toolTip = "Quantum is the creator of Quantum Menu, and has been working on it since 2023. He was also the owner of Quantum Software. Both have rebranded ever since 2/24/2026."},
                new ButtonInfo { buttonText = "Kingofnetflix", method =() => Process.Start("https://github.com/kingofnetflix"), isTogglable = false, toolTip = "Kingofnetflix is a developer for Quantum Menu. Creating mods since 2022, he's been very impactful towards this menu."},
                ...
                new ButtonInfo { buttonText = "Joseph", method =() => Process.Start("https://github.com/josephabyt"), isTogglable = false, toolTip = "Joseph is a contributor of Quantum Menu. He is the creator of many mods, like the debug screen, extenders, disable menu title, steam refund timer, and many more."},
                new ButtonInfo { buttonText = "Tagdoesnothing", method =() => Process.Start("https://github.com/JuanLeoson"), isTogglable = false, toolTip = "Tag is a contributor of Quantum Menu. She fixes small bugs and helps bug test the menu."},
                new ButtonInfo { buttonText = "DrPerky", method =() => Process.Start("https://github.com/DrPerkyLegit"), isTogglable = false, toolTip = "DrPerky is a contributor of Quantum Menu. He helped me rewrite all of the visual mods."},
                new ButtonInfo { buttonText = "ShibaGT", method =() => Process.Start("https://github.com/ShibaGT"), isTogglable = false, toolTip = "ShibaGT is a contributor of Quantum Menu. He gave me a coroutine manager, and creates minor things for the menu."},

                new ButtonInfo { buttonText = "TestofficialXD", method =() => Process.Start("https://github.com/TestofficialXD"), isTogglable = false, toolTip = "TestofficialXD is a contributor of Quantum Menu. He wrote the initial critter mods, and gave me the idea for Tag Sounds."},
                new ButtonInfo { buttonText = "Leetus", method =() => Process.Start("https://github.com/leetus"), isTogglable = false, toolTip = "Leetus is a contributor of Quantum Menu. He makes minor optimizations to mods in the menu."},
