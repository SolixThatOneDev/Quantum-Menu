/*
 * Quantum Menu  Classes/Mods/PortalTrigger.cs
...
namespace Quantum.Classes.Mods
{
    public class PortalTrigger : MonoBehaviour
    {
        ...
        {
            if (other == GorillaLocomotion.GTPlayer.Instance.bodyCollider || other == GorillaLocomotion.GTPlayer.Instance.headCollider)
