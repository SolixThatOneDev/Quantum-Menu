/*
 * Quantum Menu  Utilities/ControllerUtilities.cs
...
namespace Quantum.Utilities
{
    public class ControllerUtilities
    {
        ...
        public static (Vector3 position, Quaternion rotation, Vector3 up, Vector3 forward, Vector3 right) GetTrueHandPosition(bool left)
        {
            ...
            global::GorillaLocomotion.GTPlayer.HandState handState = left ? global::GorillaLocomotion.GTPlayer.Instance.LeftHand : global::GorillaLocomotion.GTPlayer.Instance.RightHand;

            Quaternion rot = controllerTransform.rotation * handState.handRotOffset;
            return (controllerTransform.position + controllerTransform.rotation * (handState.handOffset * global::GorillaLocomotion.GTPlayer.Instance.scale), rot, rot * Vector3.up, rot * Vector3.forward, rot * Vector3.right);
        }
