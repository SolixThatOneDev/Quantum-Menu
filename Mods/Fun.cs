...
namespace Quantum.Mods
{
    public static class Fun
    {
        ...
        public static void FlipHands()
        {
            ...
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.position = lh;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).transform.position = rh;

            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.rotation = lhr;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).transform.rotation = rhr;
        }
                    ...
                    case RpcTarget target:
                        {
                            ...
                            {
                                ObjectPools.instance.Instantiate(GorillaLocomotion.GTPlayer.Instance.waterParams.rippleEffect, splashPosition, splashRotation, GorillaLocomotion.GTPlayer.Instance.waterParams.rippleEffectScale * boundingRadius * 2f);
                                ObjectPools.instance.Instantiate(GorillaLocomotion.GTPlayer.Instance.waterParams.splashEffect, splashPosition, splashRotation, splashScale).GetComponent<WaterSplashEffect>().PlayEffect(bigSplash, enteringWater, splashScale);
        ...
        public static void Freecam()
        {
            ...
            {
                FreeCamObject = new GameObject("Quantum_CameraObj");
        ...
        public static void CustomVirtualStumpVideo() =>
            virtualStumpAd ??= new GameObject("Quantum_VirtualStumpAd").AddComponent<VirtualStumpAd>();
...
Piece Name: {gunTarget.name}";
        ...
        public static void HoverboardScreenTarget(VRRig rig, Color color)
        {
            ...
            GorillaLocomotion.GTPlayer.Instance.SetHoverboardPosRot(HoverboardPos, HoverboardRotation);
        }
        ...
        public static void BugSpam()
        {
            ...
            if (rightGrab)
            {
                if (Time.time > bugSpamDelay)
                {
                    ...
                    GameObject bugSpamObject = new GameObject("Quantum_BugSpamObject");
        ...
        public static void CameraSpam()
        {
            if (rightGrab && Time.time > cameraSpamDelay)
            {
                ...
                GameObject cameraSpamObject = new GameObject("Quantum_CameraSpamObject");
                    ...
                    case 1:
                        {
                            ...
                            GameObject bugSpamObject = new GameObject("Quantum_FireflySpamObject");
                            bugSpamObject.transform.localScale = Vector3.one * 0.2f;
                            bugSpamObject.layer = 3;
        ...
        {
            if (File.Exists($"{PluginInfo.BaseDirectory}/Quantum_CustomNameCycle.txt"))
                names = File.ReadAllText($"{PluginInfo.BaseDirectory}/Quantum_CustomNameCycle.txt").Split('\n');
            else
                File.WriteAllText($"{PluginInfo.BaseDirectory}/Quantum_CustomNameCycle.txt", "YOUR\nTEXT\nHERE");
        }
