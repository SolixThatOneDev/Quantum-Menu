...
namespace Quantum.Mods
{
    public static class Safety
    {
        ...
        public static void FakeBrokenController()
        {
            ...
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).position = GorillaLocomotion.GTPlayer.Instance.headCollider.transform.position + GorillaLocomotion.GTPlayer.Instance.headCollider.transform.up * (-0.5f * GorillaLocomotion.GTPlayer.Instance.scale);
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).rotation = Camera.main.transform.rotation * Quaternion.Euler(-55f, 90f, 0f);

            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).position = Position;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).rotation = Rotation;
        ...
        public static void ChangeIdentityCustom()
        {
            ...
            if (File.Exists(fileName))
            {
                ...
                File.WriteAllText(fileName, "Quantum;me\n9b59b6;ffffff");
