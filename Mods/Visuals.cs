...
namespace Quantum.Mods
{
    public class Visuals
    {
        ...
        {
            string text = "";
            text += $"<color=blue><b>Quantum</b></color> {PluginInfo.Version}  <color=grey>|</color>  Users Online:  {ServerData.onlineUsers}" + "\\n \\n";
        ...
        */
        ...
        public static TMP_SpriteAsset InfoSprites
        {
            get
            {
                if (_infoSpriteAsset == null)
                {
                    ...
                    _infoSpriteAsset.name = "Quantum_InfoSprites";
        ...
        public static void WatchStep()
        {
            ...
            if (infoWatchMenuName || defaultWatch) watchTextComponent.text = "Quantum Menu\n<color=grey>";
        ...
        public static void DrawGun()
        {
            if (GetGunInput(false))
            {
                ...
                {
                    GameObject trailHolder = new GameObject("Quantum_DrawGunTrail");
        ...
        public static void GetLabel(string codeName, bool leftHand, string text, Color color)
        {
            if (!labelDictionary.TryGetValue(codeName, out GameObject go))
            {
                ...
                go.transform.localScale = Vector3.one * (0.25f * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f));
            ...
            go.transform.position = (leftHand ? GorillaTagger.Instance.leftHandTransform : GorillaTagger.Instance.rightHandTransform).position + Vector3.up * (GetLabelDistance(leftHand) * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f));
        ...
        public static void VelocityLabel()
        {
            ...
            (
                ...
                GorillaTagger.Instance.rigidbody.linearVelocity.magnitude >= GorillaLocomotion.GTPlayer.Instance.maxJumpSpeed ? Color.green : Color.white
            );
        }
        ...
        public static void DrawTrajectory(Vector3 position, Vector3 velocity, LineRenderer lineRenderer, int? overrideLayerMask = null, Vector3? overrideGravity = null)
        {
            ...
            for (i = 0; i < stepCount; i++)
            {
                ...
                if (i >= 1 && Physics.Raycast(position, nextPosition - position, out RaycastHit hit, (nextPosition - position).magnitude, overrideLayerMask ?? GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers))
                {
                    points[i] = hit.point;
                    i++;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_Veltag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_FPStag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_IDtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_PlatformTag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
                ...
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!kidNameTags.ContainsKey(vrrig))
                        {
                            ...
                            {
                                GameObject go = new GameObject("Quantum_Kidtag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
                ...
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!subNameTags.ContainsKey(vrrig))
                        {
                            ...
                            {
                                GameObject go = new GameObject("Quantum_SubscriberTag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_CreationTag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_Pingtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_Turntag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_Taggedtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_Modtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
                    ...
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!crashedNameTags.ContainsKey(vrrig))
                        {
                            ...
                            if (crashed)
                            {
                                ...
                                GameObject go = new GameObject("Quantum_Crashedtag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject textContainer = new GameObject("Quantum_vrctag_text");
                            if (hoc)
                            ...
                            GameObject bgContainer = new GameObject("Quantum_vrctag_background");
                            if (hoc)
        ...
        public static void MinecraftTags()
        {
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                ...
                {
                    GameObject tagContainer = new GameObject("Quantum_MinecraftTag");
                    if (hoc)
            ...
            foreach (VRRig vrrig in VRRigCache.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Quantum_CastingTag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
        ...
        public static void CasualTracers()
        {
            ...
            float lineWidth = (Buttons.GetIndex("Thin Tracers").enabled ? 0.0075f : 0.025f) * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f);
