...
using static Quantum.Managers.VoiceManager;
...
namespace Quantum.Mods
{
    public static class Movement
    {
        ...
        public static Vector3 GetPlatformScale()
        {
            ...
            }[platformShape] * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f);
        }
        ...
        public static void SetPlatformPosition(GameObject platform, bool left)
        {
            ...
            if (Buttons.GetIndex("Non-Sticky Platforms").enabled)
                platform.transform.position += right * ((left ? 1f : -1f) * ((0.025f + platform.transform.localScale.x / 2f) * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f)));
        ...
        {
            get => _flySpeed * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f);
            set => _flySpeed = value;
        }
        ...
        public static void HandleFrozone(bool left)
        {
            ...
            if (grip)
            {
                ...
                else
                {
                    ...
                    platform.transform.localScale = new Vector3(0.025f, 0.3f, 0.4f) * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f);
                ...
                platform.transform.position = position + (right * ((left ? 1f : -1f) * ((0.025f + platform.transform.localScale.x / 2f) * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f))));
                platform.transform.rotation = rotation;
        ...
        public static void BarkFly()
        {
            ...
            Vector3 playerForward = GorillaLocomotion.GTPlayer.Instance.bodyCollider.transform.forward.X_Z();
            Vector3 playerRight = GorillaLocomotion.GTPlayer.Instance.bodyCollider.transform.right.X_Z();
        ...
        public static void HandFly()
        {
            if (rightPrimary)
            {
                GorillaLocomotion.GTPlayer.Instance.transform.position += ControllerUtilities.GetTrueRightHand().forward * (Time.deltaTime * FlySpeed);
                GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
            }
        }
        ...
        public static void FlyTowardsGun()
        {
            if (GetGunInput(false))
            {
                ...
                {
                    GorillaLocomotion.GTPlayer.Instance.transform.position += (lockTarget.transform.position - GorillaTagger.Instance.bodyCollider.transform.position) * (Time.deltaTime * FlySpeed);
                    GorillaTagger.Instance.rigidbody.linearVelocity = Vector3.zero;
                }
        ...
        {
            if (rightPrimary)
                GorillaTagger.Instance.rigidbody.linearVelocity += GorillaLocomotion.GTPlayer.Instance.headCollider.transform.forward * (Time.deltaTime * (FlySpeed * 2));
        }
        ...
        public static void ZeroGravitySlingshotFly()
        {
            ...
            {
                ZeroGravity();
                GorillaTagger.Instance.rigidbody.linearVelocity += GorillaLocomotion.GTPlayer.Instance.headCollider.transform.forward * (Time.deltaTime * FlySpeed);
            }
        }
        ...
        public static void WASDFly()
        {
            ...
            if (!menu)
            {
                Transform parentTransform = GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).parent;
        ...
        public static void HardDrive()
        {
            ...
            if ((Mathf.Abs(leftJoystick.x) > 0.05f || Mathf.Abs(leftJoystick.y) > 0.05f) && closePosition == Vector3.zero)
            {
                ...
                Physics.Raycast(raycastPosition, Vector3.down, out var Ray, 50f, GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers);
        ...
        public static void Dash()
        {
            if (rightPrimary && !previousDash)
                GorillaTagger.Instance.rigidbody.linearVelocity += GorillaLocomotion.GTPlayer.Instance.headCollider.transform.forward * FlySpeed;
        ...
        public static void PortalGun()
        {
            ...
            if (portalGun)
            {
                ...
                Physics.Raycast(RayPoint.position, RayPoint.forward, out var ray, 512f, GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers);
            ...
            if (bluePortal && orangePortal)
            {
                ...
                GorillaLocomotion.GTPlayer.Instance.leftHand.isHolding = false;
                foreach (GameObject _ in new[] { bluePortal, orangePortal })
                {
                    ...
                    {
                        GorillaLocomotion.GTPlayer.Instance.leftHand.isHolding = true;
                        break;
                    }
                }

                GorillaLocomotion.GTPlayer.Instance.rightHand.isHolding = false;
                foreach (GameObject _ in new[] { bluePortal, orangePortal })
                {
                    if (IsOverlapping(_.transform.Find("Rim/View").GetComponent<Collider>(), ControllerUtilities.GetTrueRightHand().position, 0.1f))
                    {
                        GorillaLocomotion.GTPlayer.Instance.rightHand.isHolding = true;
                        break;
                    }
                }
                ...
                foreach (GameObject _ in new[] { bluePortal, orangePortal })
                {
                    if (IsOverlapping(_.transform.Find("Rim/View").GetComponent<Collider>(), GorillaLocomotion.GTPlayer.Instance.bodyCollider.transform.position, 0.05f))
                    {
                        GorillaLocomotion.GTPlayer.Instance.bodyCollider.enabled = false;
                        break;
                    }
                }
            }
        ...
        public static void AutoBranch()
        {
            ...
            if (isOnBranch)
                GorillaTagger.Instance.rigidbody.linearVelocity = GorillaLocomotion.GTPlayer.Instance.headCollider.transform.forward * 10f;
        ...
        public static void ReverseGravity()
        {
            ...
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).parent.rotation = Quaternion.Euler(180f, 0f, 0f);
        }

        public static void UnflipCharacter() =>
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).parent.rotation = Quaternion.identity;
        ...
        public static void LegitimateWallWalk()
        {
            ...
            if (leftGrab && (leftWallWalk || bothHands))
            {
                ...
                if (Physics.Raycast(ControllerUtilities.GetTrueLeftHand().position, -ray.normal, out var Ray, range, GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers))
            ...
            if (rightGrab && (!leftWallWalk || bothHands))
            {
                ...
                if (Physics.Raycast(ControllerUtilities.GetTrueRightHand().position, -ray.normal, out var Ray, range, GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers))
                    GorillaTagger.Instance.rigidbody.AddForce(Ray.normal * power, ForceMode.Acceleration);
            }
        }
        ...
        public static void SpiderWalk()
        {
            ...
            if (walkPos != Vector3.zero)
            {
                ...
                GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).parent.rotation = Quaternion.Lerp(GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).parent.rotation, Quaternion.LookRotation(walkNormal) * Quaternion.Euler(90f, 0f, 0f), Time.deltaTime);
                ZeroGravity();
            }
        }
            ...
            else
            {
                if (pearl != null)
                {
                    if (pearl.GetComponent<Rigidbody>() == null)
                    {
                        ...
                        comp.linearVelocity = isrighthandedpearl ? GorillaLocomotion.GTPlayer.Instance.RightHand.velocityTracker.GetAverageVelocity(true, 0) : GorillaLocomotion.GTPlayer.Instance.LeftHand.velocityTracker.GetAverageVelocity(true, 0);
                    }
                    Physics.Raycast(pearl.transform.position, pearl.GetComponent<Rigidbody>().linearVelocity, out var Ray, 0.25f, GorillaLocomotion.GTPlayer.Instance.locomotionEnabledLayers);
        ...
        public static void SpazRealHands()
        {
            if (rightPrimary)
            {
                GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).rotation = RandomQuaternion();
                GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).position = GorillaTagger.Instance.leftHandTransform.position + GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).forward * 3f;

                GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).rotation = RandomQuaternion();
                GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).position = GorillaTagger.Instance.rightHandTransform.position + GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).forward * 3f;
            }
            else
                VRRig.LocalRig.enabled = true;
        }
        ...
        public static void SlipSlap()
        {
            ...
            {
                float slidePercent = surface.slidePercentageOverride > 0f ? surface.slidePercentageOverride : GorillaLocomotion.GTPlayer.Instance.materialData[surface.overrideIndex].slidePercent;
                if (slidePercent > 0f)
                {
        ...
        public static void ClimbyHands()
        {
            ...
            if (leftGrab)
            {
                if (GorillaLocomotion.GTPlayer.Instance.IsHandTouching(true) && !leftisclimbing)
                {
                    ...
                    leftisclimbing = true;
                    GorillaLocomotion.GTPlayer.Instance.BeginClimbing(climb.AddComponent<GorillaClimbable>(), GetObject("Player Objects/Player VR Controller/GorillaPlayer/TurnParent/LeftHand Controller/GorillaHandClimber").GetComponent<GorillaHandClimber>());
                }
            }
            else
            ...
            if (rightGrab)
            {
                if (GorillaLocomotion.GTPlayer.Instance.IsHandTouching(false) && !rightisclimbing)
                {
                    ...
                    GorillaLocomotion.GTPlayer.Instance.BeginClimbing(climb.AddComponent<GorillaClimbable>(), GetObject("Player Objects/Player VR Controller/GorillaPlayer/TurnParent/RightHand Controller/GorillaHandClimber").GetComponent<GorillaHandClimber>());
                }
            }
            else
        ...
        {
            GorillaLocomotion.GTPlayer.Instance.leftHand.isHolding = !value;
            GorillaLocomotion.GTPlayer.Instance.rightHand.isHolding = !value;
        }
        ...
        public static void ProcessPullHand(bool left)
        {
            ...
            bool touchingGround = GorillaLocomotion.GTPlayer.Instance.IsHandTouching(left);
            previousTouchingGround.TryGetValue(left, out bool wasTouchingGround);

            if (!touchingGround && wasTouchingGround)
            {
                Vector3 normal = GorillaLocomotion.GTPlayer.Instance.lastHitInfoHand.normal;
                Vector3 direction = GorillaTagger.Instance.rigidbody.linearVelocity.X_Z();
                GorillaLocomotion.GTPlayer.Instance.transform.position += (direction - normal * Vector3.Dot(direction, normal)).normalized * (direction.magnitude / GorillaLocomotion.GTPlayer.Instance.maxJumpSpeed * (pullPower * 5f)) * (scaleWithPlayer ? GorillaLocomotion.GTPlayer.Instance.scale : 1f);
            }
        ...
        public static void ThrowControllers()
        {
            if (leftPrimary)
            {
                if (leftThrow != null)
                {
                    GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).position = leftThrow.transform.position;
                    GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).rotation = leftThrow.transform.rotation;
                }
                else
                {
                    ...
                    leftThrow.transform.position = GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).position;
                    leftThrow.transform.rotation = GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).rotation;
            ...
            if (rightPrimary)
            {
                if (rightThrow != null)
                {
                    GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).position = rightThrow.transform.position;
                    GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).rotation = rightThrow.transform.rotation;
                }
                else
                {
                    ...
                    rightThrow.transform.position = GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).position;
                    rightThrow.transform.rotation = GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).rotation;
        ...
        {
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).transform.position = GorillaTagger.Instance.leftHandTransform.position + GorillaTagger.Instance.leftHandTransform.forward * ((armlength - 0.917f) * GorillaLocomotion.GTPlayer.Instance.scale);
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.position = GorillaTagger.Instance.rightHandTransform.position + GorillaTagger.Instance.rightHandTransform.forward * ((armlength - 0.917f) * GorillaLocomotion.GTPlayer.Instance.scale);
        }
        ...
        public static void EnableSteamLongArms()
        {
            if (passWorldScaleCheck)
            {
                ...
                bool bothHandsNotMoving = GorillaLocomotion.GTPlayer.Instance.RightHand.velocityTracker.GetAverageVelocity(true, 0).magnitude < 2f && GorillaLocomotion.GTPlayer.Instance.LeftHand.velocityTracker.GetAverageVelocity(true, 0).magnitude < 2f;
            ...
            GorillaLocomotion.GTPlayer.Instance.transform.localScale = Vector3.one * (VRRig.LocalRig.NativeScale * armlength);
        }

        public static void DisableSteamLongArms() =>
            GorillaLocomotion.GTPlayer.Instance.transform.localScale = Vector3.one * VRRig.LocalRig.NativeScale;
        ...
        public static void Extenders()
        {
            ...
            GorillaLocomotion.GTPlayer.Instance.transform.localScale = new Vector3(delayedLength, delayedLength, delayedLength);
        }

        public static void MultipliedLongArms()
        {
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).transform.position = GorillaTagger.Instance.headCollider.transform.position - (GorillaTagger.Instance.headCollider.transform.position - GorillaTagger.Instance.leftHandTransform.position) * armlength;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.position = GorillaTagger.Instance.headCollider.transform.position - (GorillaTagger.Instance.headCollider.transform.position - GorillaTagger.Instance.rightHandTransform.position) * armlength;
        }
        ...
        public static void VerticalLongArms()
        {
            ...
            righty.y *= armlength;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).transform.position = GorillaTagger.Instance.headCollider.transform.position - lefty;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.position = GorillaTagger.Instance.headCollider.transform.position - righty;
        }
        ...
        public static void HorizontalLongArms()
        {
            ...
            righty.x *= armlength;
            righty.z *= armlength;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).position = GorillaTagger.Instance.headCollider.transform.position - lefty;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).position = GorillaTagger.Instance.headCollider.transform.position - righty;
        }
        ...
        public static void VelocityLongArms()
        {
            ...
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(true).transform.position -= lvT.GetComponent<GorillaVelocityTracker>().GetAverageVelocity(true, 0) * predCount;
            GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.position -= rvT.GetComponent<GorillaVelocityTracker>().GetAverageVelocity(true, 0) * predCount;
        }
        ...
        {
            GorillaLocomotion.GTPlayer.Instance.debugMovement = true;
        ...
        {
            if (rightPrimary)
                GorillaLocomotion.GTPlayer.Instance.GetControllerTransform(false).transform.position = GorillaTagger.Instance.rightHandTransform.position + new Vector3(0f, -1.5f, 0f);
        }
        ...
        public static void PlayspaceAbuse()
        {
            if (rightPrimary)
            {
                ...
                GorillaLocomotion.GTPlayer.Instance.transform.position += longJumpPower.Value;
            }
            else
            {
                longJumpPower = null;
        ...
        public static void BunnyHop()
        {
            ...
            if (Ray.distance < 0.15f)
                GorillaTagger.Instance.rigidbody.linearVelocity = new Vector3(GorillaTagger.Instance.rigidbody.linearVelocity.x, GorillaLocomotion.GTPlayer.Instance.jumpMultiplier * 2.727272727f, GorillaTagger.Instance.rigidbody.linearVelocity.z);
        }
        ...
        public static void Strafe()
        {
            ...
            float power = GorillaLocomotion.GTPlayer.Instance.maxJumpSpeed;
        ...
        public static void AirSwim()
        {
            ...
            {
                GorillaLocomotion.GTPlayer.Instance.audioManager.UnsetMixerSnapshot();
        ...
        public static void SetSwimSpeed(float speed = 3f) =>
            GorillaLocomotion.GTPlayer.Instance.swimmingParams.swimmingVelocityOutOfWaterDrainRate = speed;
        ...
        public static void WaterRunHelper(bool enable)
        {
            if (enable)
            {
                waterSurfaceJumpAmount = GorillaLocomotion.GTPlayer.Instance.swimmingParams.waterSurfaceJumpAmount;
                waterSurfaceJumpMaxSpeed = GorillaLocomotion.GTPlayer.Instance.swimmingParams.waterSurfaceJumpMaxSpeed;

                GorillaLocomotion.GTPlayer.Instance.swimmingParams.waterSurfaceJumpAmount = 1.25f;
                GorillaLocomotion.GTPlayer.Instance.swimmingParams.waterSurfaceJumpMaxSpeed = 4.333f;
            }
            else
            {
                GorillaLocomotion.GTPlayer.Instance.swimmingParams.waterSurfaceJumpAmount = waterSurfaceJumpAmount ?? 0.6f;
                GorillaLocomotion.GTPlayer.Instance.swimmingParams.waterSurfaceJumpMaxSpeed = waterSurfaceJumpMaxSpeed ?? 1f;
            }
        }
        ...
        public static IEnumerator Sex()
        {
            ...
            while (true)
            {
                Transform rightHand = GorillaLocomotion.GTPlayer.Instance.rightHand.controllerTransform;
                Transform leftHand = GorillaLocomotion.GTPlayer.Instance.leftHand.controllerTransform;
