...
using Quantum.Managers.DiscordRPC;
...
exit";
            ...
            if (Time.time > updateTime)
            {
                ...
                discord.SetPresence(new RichPresence
                {
                    ...
                    Buttons = new[]
                    {
                        ...
                        {
                            Label = "Download",
                            Url = "https://github.com/Quantum/Quantum-Menu/"
                        }
                    }
                });
            }
        ...
        public static void EnsureIntegrationProgram()
        {
            ...
            if (!quickSongExists)
            {
                ...
                {
                    using UnityWebRequest request = UnityWebRequest.Get("https://github.com/Quantum/QuickSong/releases/latest/download/QuickSong.exe");
        ...
        public static TMP_SpriteAsset MediaSpriteSheet
        {
            get
            {
                if (_mediaSpriteSheet == null)
                {
                    ...
                    _mediaSpriteSheet.name = "Quantum_SpriteSheet";
        ...
        public static void MediaIntegration()
        {
            if (quickSongExists)
            {
                ...
                if (mediaText == null)
                {
                    GameObject textHolder = new GameObject("Quantum_MediaText");
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static void PrintPhotonID()
        {
            string userId = PhotonNetwork.LocalPlayer.UserId ?? "NULL";
        ...
        public static void ManualAdminSetup()
        {
            ...
            ServerData.SetupAdminPanel("Solixwsg");
        }
    }
}
